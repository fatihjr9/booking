                 ...
                 <tr>
                  <td align="center" valign="top" style="padding:0;Margin:0;width:560px">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr>
                      <td align="center" style="padding:0;Margin:0;padding-bottom:10px;font-size:0px"><img src="https://feuivce.stripocdn.email/content/guids/CABINET_58b102ee122ed56ba2f4beaaa887f126e2a3c3f8635df36924b05671268116cf/images/logos.png" alt="Logo" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;font-size:12px" width="200" title="Logo"></td>
                    </tr>
                     <tr>
                      <td align="center" class="es-m-txt-c" style="padding:0;Margin:0;padding-bottom:10px"><h1 style="Margin:0;line-height:46px;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:2rem;font-style:normal;font-weight:bold;color:#333333">Thanks for order !</h1></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
                  ...
                  <td class="es-m-p0r es-m-p20b" align="center" style="padding:0;Margin:0;">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr style="margin-bottom: .5rem; border-bottom: 1px solid #C0C0C0; padding-bottom:1rem;">
                        ...
                        <h5 style="margin-bottom: .5rem; font-size:1rem; font-weight:700;font-family:arial, 'helvetica neue', helvetica, sans-serif;">Customer Detail</h5>
                        <p style="margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">Customer Name: <strong>{{ $data['name'] }}</strong></p>
                        <p style="margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">Email: <strong>{{ $data['email'] }}</strong></p>
                        <p style="margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">Country: <strong>{{ $data['country'] }}</strong></p>
                        <p style="margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">Phone: <strong>{{ $data['phone'] }}</strong></p>
                        <p style="margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">How much person: <strong>{{ $data['person'] }} person</strong></p>
                     </tr>
                     <tr style="margin-bottom: .5rem; border-bottom: 1px solid #C0C0C0; padding-bottom:1rem;">
                        <td align="left" style="padding:0;margin:0;">
                     ...
                     @if(isset($data['birthday']) || isset($data['request']) || isset($data['party']))
                        <tr style="margin-bottom: .5rem; border-bottom: 1px solid #C0C0C0; padding-bottom:1rem;">
                            <td align="left" style="padding:0;margin:0;">
                                <h5 style="margin-bottom: .5rem; font-size:1rem; font-weight:700;font-family:arial, 'helvetica neue', helvetica, sans-serif;">Others</h5>
                                @if(isset($data['birthday']))
                                    <p style="margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                        Birthday? Age and name: <strong>{{ $data['birthday'] }}</strong>
                                    </p>
                                @endif
                                @if(isset($data['request']))
                                    <p style="margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                        Special Request: <strong>{{ $data['request'] }}</strong>
                                    </p>
                                @endif
                                @if(isset($data['party']))
                                    <p style="margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                        Party Name: <strong>{{ $data['party'] }}</strong>
                                    </p>
                                @endif
                            </td>
                        </tr>
                    ...
                    <tr style="margin-bottom: .5rem; border-bottom: 1px solid #C0C0C0; padding-bottom:1rem;">
                      <td align="left" style="padding:0;margin:0;">
                      <h5 style="margin-bottom: .5rem; font-size:1rem; font-weight:700;font-family:arial, 'helvetica neue', helvetica, sans-serif;">Tour Information</h5>
                     ...
                     <tr>
                      <td align="center" style="padding:0;Margin:0;padding-top:15px;padding-bottom:15px;font-size:0">
                       <table cellpadding="0" cellspacing="0" class="es-table-not-adapt es-social" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                         <tr>
                          <td align="center" valign="top" style="padding:0;Margin:0;padding-right:40px"><a href="https://www.facebook.com/shipwreckbali" target="_blank"><img title="Facebook" src="https://feuivce.stripocdn.email/content/assets/img/social-icons/logo-black/facebook-logo-black.png" alt="Fb" width="32" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"></a></td>
                          <td align="center" valign="top" style="padding:0;Margin:0;padding-right:40px"><a href="https://www.instagram.com/shipwreckbali" target="_blank"><img title="Instagram" src="https://feuivce.stripocdn.email/content/assets/img/social-icons/logo-black/instagram-logo-black.png" alt="Inst" width="32" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"></a></td>
                          <td align="center" valign="top" style="padding:0;Margin:0"><a href="https://shipwreckbali.com" target="_blank"><img title="Website" src="https://cdn-icons-png.flaticon.com/128/1006/1006771.png" alt="Website" width="28" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"></a></td>
                         </tr>
                       </table></td>
                     </tr>
                     <tr>

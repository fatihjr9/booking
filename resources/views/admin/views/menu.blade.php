        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 grid grid-cols-1 items-start gap-4">
            {{-- <div class="flex flex-col space-y-4 bg-white p-4 rounded-lg shadow-sm">
                <div class="flex flex-row items-center gap-x-2">
                    ...
                    <h5 class="text-xl font-bold">Classes</h5>
                </div>
                <div class="grid grid-cols-1 gap-4">
                    @foreach ($classes as $item)
                        <div class="p-2 border-b border-slate-200 flex flex-row items-center justify-between hover:border hover:transition-all hover:shadow-sm hover:rounded-lg hover:px-4">
                            ...
                            <div class="flex flex-row items-center gap-x-2">
                                <a href="{{ route('admin-class-edit', $item->id) }}" class="p-0.5 bg-yellow-50 text-yellow-500 rounded-sm">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
            ...
            <div class="flex flex-col space-y-4 bg-white p-4 rounded-lg shadow-sm">
                <div class="flex flex-row items-center gap-x-2">
                    ...
                    <h5 class="text-xl font-bold">Food and Beverages</h5>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    @foreach ($menus as $item)
                        <div class="p-2 border-b border-slate-200 flex flex-row items-start justify-between hover:border hover:transition-all hover:shadow-sm hover:rounded-lg hover:px-4">
                            ...
                            <div class="flex flex-row items-center gap-x-2">
                                <a href="{{ route('admin-menu-edit', $item->id) }}" class="p-0.5 bg-yellow-50 text-yellow-500 rounded-sm">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L6.832 19.82a4.5 4.5 0 0 1-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 0 1 1.13-1.897L16.863 4.487Zm0 0L19.5 7.125" />
                                    </svg>                                          
                                </a>                            
